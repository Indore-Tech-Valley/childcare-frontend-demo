...
import WhiteLogo from '../Navbar/Logo/ChildCareClinic_White.png';
import BlackLogo from '../Navbar/Logo/ChildCareClinic_Black.png';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          <img src={logo} alt="ChildCareClinic logo" className="w-auto lg:h-14 h-12" />
        </Link>

        {/* Desktop Nav */}
        <nav
          className={`${
            scrolled || isMobile ? 'bg-white text-black' : 'text-white'
          } hidden md:flex gap-8 text-md font-medium`}
        >
          ...
          <Link to="/about#pediatricians" className="relative group">
            <span className="transition-colors duration-300">Pediatricians</span>
            <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link
            to="/#appointment"
            className="relative group hidden md:inline-block bg-blue-600 hover:bg-[#10244b] text-white px-6 py-3 rounded-lg font-semibold text-md overflow-hidden min-w-[160px] h-[44px] transition-colors duration-300"
          >
      ...
      >
        ...
        <Link to="/about#pediatricians" onClick={() => setMenuOpen(false)} className="block py-3 border-b border-gray-200">
          Pediatricians
        </Link>
